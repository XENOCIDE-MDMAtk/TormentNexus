...
func HandleListMemories_memora(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleAddMemory_memora(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
