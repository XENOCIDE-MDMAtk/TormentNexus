...
func HandleGetUsers_keycloak_model_context_protocol(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleCreateUser_keycloak_model_context_protocol(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	baseURL, _ :=getString(args, "base_url")
	realm, _ :=getString(args, "realm")
	token, _ :=getString(args, "token")
