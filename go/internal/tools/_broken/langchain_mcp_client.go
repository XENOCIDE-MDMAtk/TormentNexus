...
func HandleConnect_langchain_mcp_client(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleQuery_langchain_mcp_client(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
