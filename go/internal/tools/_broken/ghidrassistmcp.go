...
func HandleAnalyze_ghidrassistmcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleDecompile_ghidrassistmcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
