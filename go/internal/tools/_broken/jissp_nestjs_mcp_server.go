...
func HandleListTools_jissp_nestjs_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleCallTool_jissp_nestjs_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
