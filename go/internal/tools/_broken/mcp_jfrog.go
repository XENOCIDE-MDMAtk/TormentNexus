...
func HandleListRepos_mcp_jfrog(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleSearch_mcp_jfrog(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	baseURL, _ :=getString(args, "url")
	token, _ :=getString(args, "token")
