...
func HandleListModels_mcp_client_for_ollama(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGenerate_mcp_client_for_ollama(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
