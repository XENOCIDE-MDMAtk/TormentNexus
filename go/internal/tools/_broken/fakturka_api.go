...
func HandleCreateInvoice_fakturka_api(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleListInvoices_fakturka_api(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	apiKey := os.Getenv("FAKTURKA_API_KEY")
	if apiKey == "" {
		return err("FAKTURKA_API_KEY not set")
}
