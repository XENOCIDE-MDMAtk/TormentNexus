...
func HandleListIntegrations_benchclaw_integrations(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func toString_benchclaw_integrations(v interface{}) string {
	b, _ := json.Marshal(v)
	return string(b)
}