...
func HandleListUsers_roadrecon_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetUser_roadrecon_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
