...
func HandleListEndpoints_noveum_ai_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func joinStrings_noveum_ai_mcp_server(s []string) string {
	if len(s) == 0 {
		return "[]"
	}
	result := "["
