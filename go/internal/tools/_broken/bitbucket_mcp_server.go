...
func HandleListRepositories_bitbucket_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetRepository_bitbucket_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	workspace, _ :=getString(args, "workspace")
