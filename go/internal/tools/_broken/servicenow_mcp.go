...
func HandleGetIncident_servicenow_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleListIncidents_servicenow_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	instance, _ :=getString(args, "instance_url")
	table, _ :=getString(args, "table")
	if table == "" {
		table = "incident"
