...
func HandleListCourses_charlie_act7_canvas_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleListAssignments_charlie_act7_canvas_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	apiToken, _ :=getString(args, "apiToken")
	baseURL, _ :=getString(args, "baseURL")
