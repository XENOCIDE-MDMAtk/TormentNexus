...
func HandleListEvents_cal_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleCreateEvent_cal_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
