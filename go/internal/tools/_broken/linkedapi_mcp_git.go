...
func HandleSearchRepos_linkedapi_mcp_git(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetUser_linkedapi_mcp_git(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
