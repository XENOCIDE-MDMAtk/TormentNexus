...
func HandleGetAnalytics_osp_marketing_tools(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func toReader_osp_marketing_tools(data []byte) io.Reader {
