...
func HandleStoreMemory_memorymesh(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleRetrieveMemory_memorymesh(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	key, _ :=getString(args, "key")
	if key == "" {
