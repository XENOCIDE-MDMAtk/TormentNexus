...
func HandleCreateTask_claude_task_master(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleListTasks_claude_task_master(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
