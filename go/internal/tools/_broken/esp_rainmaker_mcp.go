...
func HandleListDevices_esp_rainmaker_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleSendCommand_esp_rainmaker_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	apiKey, _ :=getString(args, "api_key")
