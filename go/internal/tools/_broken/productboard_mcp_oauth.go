...
func HandleListFeatures_productboard_mcp_oauth(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleCreateFeature_productboard_mcp_oauth(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	token, _ :=getString(args, "token")
