...
func HandleListClusters_databricks_mcp_server_linux_amd64(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetCluster_databricks_mcp_server_linux_amd64(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	host, _ :=getString(args, "host")
	token, _ :=getString(args, "token")
