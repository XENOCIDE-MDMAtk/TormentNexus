...
func HandleGetState_homeassistant_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleCallService_homeassistant_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
