...
func HandleGetBalance_nwc_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandlePayInvoice_nwc_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	serverURL, _ :=getString(args, "server_url")
	walletID, _ :=getString(args, "wallet_id")
