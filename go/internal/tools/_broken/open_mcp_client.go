...
func HandleX_open_mcp_client(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleY_open_mcp_client(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
