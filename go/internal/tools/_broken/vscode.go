...
func HandleOpenFile_vscode(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleExecuteCommand_vscode(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
