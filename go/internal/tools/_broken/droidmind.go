...
func HandleListDevices_droidmind(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleExecuteCommand_droidmind(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
