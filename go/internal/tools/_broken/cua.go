...
func HandleGetUser_cua(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleCreateUser_cua(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
