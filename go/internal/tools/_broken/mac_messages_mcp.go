...
func HandleListConversations_mac_messages_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleSendMessage_mac_messages_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
