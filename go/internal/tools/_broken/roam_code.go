...
func HandleListFiles_roam_code(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetFile_roam_code(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
