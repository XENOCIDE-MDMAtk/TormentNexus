...
type searchResult_geobio_mcp_open_library struct {
...
func HandleSearchBooks_geobio_mcp_open_library(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
