...
func HandleChat_cf_mcp_client(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleStatus_cf_mcp_client(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
