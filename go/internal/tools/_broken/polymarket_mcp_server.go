...
func HandleGetMarket_polymarket_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandlePlaceBet_polymarket_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	marketId, _ :=getString(args, "marketId")
