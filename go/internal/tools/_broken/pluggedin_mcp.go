...
func HandleHello_pluggedin_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleTime_pluggedin_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
