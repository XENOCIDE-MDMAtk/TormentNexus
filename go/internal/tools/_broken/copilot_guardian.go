...
func HandleListRepos_copilot_guardian(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetRepo_copilot_guardian(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
