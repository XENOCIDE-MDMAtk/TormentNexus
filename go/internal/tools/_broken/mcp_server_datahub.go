...
func HandleSearchDatasets_mcp_server_datahub(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func itoa_mcp_server_datahub(i int) string {
	if i == 0 {
		return "0"
	}
	s := ""
