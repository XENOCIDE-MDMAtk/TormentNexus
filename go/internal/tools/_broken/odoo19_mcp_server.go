...
func HandleSearch_odoo19_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleCreate_odoo19_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	url, _ :=getString(args, "url")
	db, _ :=getString(args, "db")
	user, _ :=getString(args, "user")
	pass, _ :=getString(args, "pass")
