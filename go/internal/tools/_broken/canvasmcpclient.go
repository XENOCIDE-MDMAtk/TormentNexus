...
func HandleListCourses_canvasmcpclient(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleListAssignments_canvasmcpclient(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
