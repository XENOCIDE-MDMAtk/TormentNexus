...
func HandleSearchNotes_engram_rs(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleCreateNote_engram_rs(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
