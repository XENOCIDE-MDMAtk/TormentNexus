...
func HandleListProducts_shopify_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetOrder_shopify_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	shop, _ :=getString(args, "shop")
	token, _ :=getString(args, "access_token")
