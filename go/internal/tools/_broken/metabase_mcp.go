...
func HandleListDashboards_metabase_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleRunQuery_metabase_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	host, _ :=getString(args, "host")
	key, _ :=getString(args, "api_key")
