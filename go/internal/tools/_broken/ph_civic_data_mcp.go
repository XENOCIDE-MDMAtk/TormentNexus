...
func HandleListRegions_ph_civic_data_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func joinStrings_ph_civic_data_mcp(strs []string, sep string) string {
	if len(strs) == 0 {
		return ""
	}
	result := strs[0]
