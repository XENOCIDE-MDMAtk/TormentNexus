...
func HandleListEndpoints_spring_boot_starter_swagger_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetEndpoint_spring_boot_starter_swagger_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	baseURL, _ :=getString(args, "baseURL")
