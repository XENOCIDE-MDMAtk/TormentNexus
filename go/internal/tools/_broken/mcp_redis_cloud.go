...
func HandleSet_mcp_redis_cloud(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGet_mcp_redis_cloud(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	key, _ :=getString(args, "key")
	if key == "" {
