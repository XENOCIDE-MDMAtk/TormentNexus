...
func HandleListWorkflows_n8n_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleExecuteWorkflow_n8n_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
