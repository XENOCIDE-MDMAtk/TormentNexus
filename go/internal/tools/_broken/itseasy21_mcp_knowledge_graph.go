...
var store_itseasy21_mcp_knowledge_graph = make(map[string]map[string][]string)

func HandleAddTriple_itseasy21_mcp_knowledge_graph(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
