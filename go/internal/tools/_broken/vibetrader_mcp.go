...
func HandleGetMarketData_vibetrader_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandlePlaceOrder_vibetrader_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	symbol, _ :=getString(args, "symbol")
