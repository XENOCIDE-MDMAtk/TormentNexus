...
func HandleGetMarkets_flipcoin_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandlePlaceBet_flipcoin_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
