...
func HandleSearchMovie_wizzy_mcp_tmdb(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetMovieDetails_wizzy_mcp_tmdb(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
