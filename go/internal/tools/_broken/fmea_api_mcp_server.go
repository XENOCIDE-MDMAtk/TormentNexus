...
func HandleListEndpoints_fmea_api_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	dir := "endpoints"
...
func HandleGetEndpoint_fmea_api_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
