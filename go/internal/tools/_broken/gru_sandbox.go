...
func HandleRunCode_gru_sandbox(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleListRuns_gru_sandbox(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
