...
func HandleListJobs_triggerdotdev(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleTriggerJob_triggerdotdev(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	apiKey, _ :=getString(args, "apiKey")
	if apiKey == "" {
		return err("apiKey is required")
}
