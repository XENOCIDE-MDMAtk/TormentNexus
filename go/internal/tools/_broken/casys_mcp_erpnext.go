...
func HandleListDocuments_casys_mcp_erpnext(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetDocument_casys_mcp_erpnext(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	doctype, _ :=getString(args, "doctype")
