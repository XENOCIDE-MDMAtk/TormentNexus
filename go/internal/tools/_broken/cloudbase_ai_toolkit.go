...
func HandleListModels_cloudbase_ai_toolkit(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleExecuteWorkflow_cloudbase_ai_toolkit(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
