...
func HandleX_mcp_clients(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleY_mcp_clients(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
