...
func HandleListKernels_fre4x_jupyter(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleExecuteCode_fre4x_jupyter(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
