...
func HandleGenerateCode_vibeue(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleAnalyzeCode_vibeue(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
