...
func HandleX_typescript_mcp_client(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleY_typescript_mcp_client(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
